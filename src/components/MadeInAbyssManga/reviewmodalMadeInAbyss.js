...
import ReviewCreateMadeInAbyss from '../MadeInAbyssManga/reviewcreateMadeInAbyss';


const ReviewModalMadeInAbyss = (props) => {
    console.log(props)
  const {
    buttonLabel,
    className
  ...
  return (
    <div>
      ...
      <Modal top width="100%" isOpen={modal} toggle={toggle} className={className}>
        ...
        <ModalBody>
        <ReviewCreateMadeInAbyss token={props.token}/>
        </ModalBody>
        <ModalFooter>
        </ModalFooter>
      </Modal>
...
export default ReviewModalMadeInAbyss;