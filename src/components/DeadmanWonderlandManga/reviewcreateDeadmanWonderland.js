...
const ReviewCreateDeadmanWonderland = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${APIURL}/manga/reviewdeadmanwonderland`, {
            method:'POST',
    ...
    return(
        <>
        <h3>Write a Review For Deadman Wonderland</h3>
        <Form onSubmit={handleSubmit}>
            ...
            <Label htmlFor="reviewer"/>
                ...
                <h3>Rate 1-5</h3>
                <Input type="select" placeholder='Type Your Review Here' name ="rating" value={rating} onChange={(e) => setRating(e.target.value)}>
...
export default ReviewCreateDeadmanWonderland;